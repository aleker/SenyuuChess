...
def is_checkmate(game_pk, color_in_check, is_in_check):
    if is_in_check is False:
        return None
    if check_if_king_can_run(game_pk, color_in_check) is False:
        return color_in_check
    return None
